...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        touchgfx_fonts[0] = &(getFont_verdana_80_4bpp());
        break;
    case 1:
        touchgfx_fonts[1] = &(getFont_himalaya_45_4bpp());
        break;
    case 2:
